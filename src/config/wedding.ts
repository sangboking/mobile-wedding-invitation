...
export const wedding = {
  ...
  venue: {
    ...
    transport: [
      {
        label: "대중교통",
        desc: "1·2호선 신도림역 1번 출구(무료 셔틀버스 운행)\n1호선 구로역 3번 출구(도보 10분)",
      },
      {
        label: "무료셔틀",
        desc: "신도림역 1번 출구 맞은편 ↔ 더링크호텔 간 왕복\n(약 5-10분 간격 수시 운행)",
      },
      {
        label: "자가용",
        desc: "호텔 지하 주차장(B1-B6) 및 외부 주차장 이용\n(당일 주차요원 안내에 따라 주차)\n1시간 30분 무료 주차 / 초과 시 15분당 1,000원\n(카드 가능) 주차권, 도장, 사전결산 필요 없음",
      },
    ],
  },
  ...
  accounts: {
    groom: {
      ...
      list: [
        ...
        { role: "아버지", name: "박흥규", bank: "우리은행", number: "103-286581-12-001", kakaopay: "" },
        { role: "어머니", name: "이혜자", bank: "농협", number: "352-1746-2734-63", kakaopay: "" },
      ],
    },
    bride: {
      title: "신부측 계좌번호",
      list: [
        ...
        { role: "어머니", name: "박현아", bank: "카카오뱅크", number: "3333-14-5152635", kakaopay: "" },
      ],
    },
  },
  ...
  // 자주 묻는 질문
  faq: [
    { q: "두 분은 어떻게 만났나요? ❤️", a: "가족 지인의 소개로 운명처럼 만났어요!" },
    { q: "둘은 몇 살 차이인가요? 👀", a: "신랑은 97년생, 신부는 99년생! 딱 두 살 차이 커플이랍니다" },
    { q: "신혼여행은 어디로 며칠간 가나요? ✈️", a: "낭만 가득 이탈리아로 12박 13일 다녀올 거예요!" },
    { q: "신혼집은 어디인가요? 🏡", a: "따끈따끈한 우리 둘의 보금자리, 안양에서 시작해요!" },
  ],

  // 메타데이터 / 카카오 공유용
  meta: {
    siteUrl: "https://sanghoon-minjae.vercel.app", // 배포 도메인
    ogImage: "/og-image-2.jpg", // public/og-image-2.jpg (1200x630 권장)
  },
} as const;
